...
use LucasSouzaa\Imap\Exception\ImapStatusException;
use LucasSouzaa\Imap\Exception\InvalidSearchCriteriaException;
...
use LucasSouzaa\Imap\Search\LogicalOperator\All;
...
final class Mailbox implements MailboxInterface
{
    ...
    public function getMessages(ConditionInterface $search = null, int $sortCriteria = null, bool $descending = false, string $charset = null): MessageIteratorInterface
    {
        ...
        // We need to clear the stack to know whether imap2_last_error()
        // is related to this imap2_search
        \imap2_errors();
        ...
        if (false === $messageNumbers) {
            // imap2_search can also return false
            $messageNumbers = [];
        }
    ...
    public function getThread(): array
    {
        ...
        $tree = \imap2_thread($this->resource->getStream(), \SE_UID);
     ...
     *
     * @throws \LucasSouzaa\Imap\Exception\MessageMoveException
     */
     ...
     *
     * @throws \LucasSouzaa\Imap\Exception\MessageCopyException
     */
